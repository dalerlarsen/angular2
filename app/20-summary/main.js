System.register(["angular2/platform/browser", "angular2/core", "./todo/services/todo-service", "./todo/components/todo-input", "./todo/components/todo-list", "./todo/components/status-selector", "./search/components/search-box"], function(exports_1) {
    ...
    var browser_1, core_1, todo_service_1, todo_input_1, todo_list_1, status_selector_1, search_box_1;
    var App;
    return {
        setters:[
